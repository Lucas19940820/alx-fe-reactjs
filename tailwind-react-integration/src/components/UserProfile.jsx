function UserProfile() {
    return (
        <div className="user-profile bg-gray-100 sm:p-4 md:p-8 max-w-xs sm:md:max-w-sm md:max-w-sm mx-auto my-20 rounded-lg shadow-lg hover:shadow.xl">
            <img
            ...
            <h1 className="text-lg md: text-xl sm: text-xl text-blue-800 my-4 hover: text-blue-500">John Doe</h1>
